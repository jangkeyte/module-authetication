...
return new class extends Migration
{
    ...
    {
        Schema::dropIfExists((config('authetication.table_prefix') ?? '') . 'roles_permissions');
        Schema::create((config('authetication.table_prefix') ?? '') . 'roles_permissions', function (Blueprint $table) {
